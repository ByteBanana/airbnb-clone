...
const InfoCard = ({
  ...
  return (
    <div
      className='flex px-4 transition duration-500 ease-out border-b cursor-pointer py-7 hover:opacity-80 hover:shadow-lg first:border-t'
    >
      ...
      <div className='flex flex-col flex-grow pl-5'>
        ...
        <div className='flex flex-row items-end justify-between pt-5'>
          <p>
